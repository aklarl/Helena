...
/**
 * This exception is thrown if a component should be accessed which is null
 * (e.g. when evaluating a plays query or creating/getting a role instance).
 * 
...
public class ComponentIsNullException extends Exception {
	...
	public ComponentIsNullException() {
	}
