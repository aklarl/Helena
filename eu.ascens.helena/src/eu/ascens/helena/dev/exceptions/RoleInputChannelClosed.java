...
/**
 * This exception is thrown if an input channel was accessed (for writing or
 * reading a message) which was already closed, i.e., the corresponding role
 * already left the ensemble.
 *
