...
public class AbstractFieldTypeGenerator extends AbstractHelenaTextGenerator {
  protected AbstractFieldTypeGenerator(final TypeReferenceSerializer serializer, final ImportManager im, final GeneratorHelper genHelper) {
    super(serializer, im, genHelper);
  }
  
  public String compile(final AbstractFieldType it, final ImportManager im) {
    StringConcatenation _builder = new StringConcatenation();
    _builder.append("protected ");
    String _wrappedTypeAsString = this.genHelper.getWrappedTypeAsString(it);
