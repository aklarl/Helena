...
public class P2p_stoppedSysManagerImplementation extends P2p_stoppedSysManager {
	public P2p_stoppedSysManagerImplementation() {
		super();
	}

	public static void main(String[] args) {
		SysManager sys = new P2p_stoppedSysManagerImplementation();
		sys.start();
	}
