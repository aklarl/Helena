...
import p2p_stopped.operations.PrintFileOperation;

public abstract class P2p_stoppedSysManager extends SysManager {
	...
	private static Map<RoleType, MultiplicityCapacityPair> getRoles()
		...
		Set<MessageType> requesterMsgsIn = Auxiliaries.getAsSet(sndAddrMsg, sndFileMsg);
		...
		Set<MessageType> routerMsgsOut = Auxiliaries.getAsSet(reqAddrMsg, sndAddrMsg, taskDoneMsg);
