...
public class Router extends Role {
	...
	protected ProcessExpression initializeRoleBehavior()
		...
		ProcessInvocation invoc1034314103 = new ProcessInvocation();
		ProcessInvocation invoc2094947759 = new ProcessInvocation();
		ProcessInvocation invoc1760111854 = new ProcessInvocation();
		...
		invoc1034314103.setInvocatedProcess(routerProc);
		invoc2094947759.setInvocatedProcess(routerProc);
		invoc1760111854.setInvocatedProcess(routerProc);
